...
var nb_commits=init_array(hashtags.length+1);
...
/* If we want shadows instead of dots
		chart.selectAll("rect")
		   ...
		   .enter().append("rect")
		     ...
		     .attr("width", mySettings.width / hashtags.length)
...
*/
    chart.selectAll("line.top")
       ...
       .enter().append("line")
         ...
         .attr("x2",  function(d, i) { return mySettings.width / hashtags.length+xx(i) -5; })
    ...
    chart.selectAll("line.right")
         .data(nb_commits)
       .enter().append("line")
         .attr("x1", function(d, i) { return xx(i) +mySettings.width / hashtags.length-5; })
         .attr("x2", function(d, i) { return xx(i) +mySettings.width / hashtags.length-5; })
         .attr("y1", function(d) { return h-yy(d)+ 1.5; })
         .attr("y2", function(d) { return h; })
         .style("stroke-dasharray", "2, 1")
         .style("stroke-width", "1")
